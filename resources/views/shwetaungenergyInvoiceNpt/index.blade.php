...
@section('content')
      ...
      <div class="card-header">
        ...
        <div class="card-tools">
          <div class="input-group input-group-sm" style="width: 150px;">
            <a href="{{ route('shwetaungenergy_invoice_npt.create') }}" class="btn btn-info">Add New Invoice</a>
          </div>
        </div>
      </div>
      <!-- /.card-header -->
        ...
        <table class="table table-hover table-stripped">
          ...
          <tr>
            ...
            <td>
              ...
              <form action="{{ route('shwetaungenergy_invoice_npt.destroy',$invoice->id)}}" method="POST">
                {{ csrf_field() }}
    ...
    <p class="text-info">{{ $invoices->links() }}</p>
  </div>
@endsection